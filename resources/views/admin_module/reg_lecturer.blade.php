...
<body>
    ...
    <div class="main-content">
        ...
        <div class="nav">
            <ul class="snip1168">
                <li class="current"><a href="#" data-hover="Register Lecturer">Register Lecturer</a></li>
                <li><a href="{{ route('view_lecturer') }}" data-hover="View Lecturers">View Lecturers</a></li>
            </ul>
        </div>

        <div class="formB">
            <form method="post" action="{{ route('create_lecturer') }}"class="formA">
                @csrf
