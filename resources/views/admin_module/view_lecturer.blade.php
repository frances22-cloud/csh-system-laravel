...
<body>
    ...
    <div class="main-content">
        ...
        <div class="nav">
            <ul class="snip1168">
                <li ><a href="{{ route('reg_lecturer') }}" data-hover="Register Lecturer">Register Lecturer</a></li>
                <li class="current"><a href="#" data-hover="View Lecturers">View Lecturers</a></li>
            </ul>
        </div>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr class="active-row">
                    ...
                    <td>{{$data->phone}}</td>
                    <td>
                        <form action="{{ route('delete_lec') }}" method="post">
                            @csrf
